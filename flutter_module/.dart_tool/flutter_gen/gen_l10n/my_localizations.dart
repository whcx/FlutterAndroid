...
/// Callers can lookup localized strings with an instance of MyLocalizations returned
/// by `MyLocalizations.of(context)`.
///
...
///
/// ```
/// import 'gen_l10n/my_localizations.dart';
///
/// return MaterialApp(
...
class _MyLocalizationsDelegate extends LocalizationsDelegate<MyLocalizations> {
  ...
  Future<MyLocalizations> load(Locale locale) {
    return SynchronousFuture<MyLocalizations>(_lookupMyLocalizations(locale));
  }
...
MyLocalizations _lookupMyLocalizations(Locale locale) {
...
switch (locale.languageCode) {
  ...
  switch (locale.countryCode) {
    case 'GB': return MyLocalizationsEnGb();
  }
  break;
}
    case 'zh': {
  switch (locale.countryCode) {
    case 'CN': return MyLocalizationsZhCn();
        case 'HK': return MyLocalizationsZhHk();
        case 'TW': return MyLocalizationsZhTw();
  }
  break;
}
}
